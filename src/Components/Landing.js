  ...
  return (
    <div>
      <ul className="top-nav hide">
        <li className={subqty===2 ? "current" : ""}><button onClick={() => {handleNav(2); setQty(2)}} onMouseOver={handlebeep} >P R O D U C T S</button></li>
        <li className={subqty===3 ? "current" : ""}><button onClick={() => {handleNav(3); setQty(3)}} onMouseOver={handlebeep}>B U Z Z</button></li>
        <li><div onClick={() => {handleNav(1); setQty(1)}}><img className="logo" src={logo} alt="Marstech logo"></img></div></li>
        <li className={subqty===4 ? "current" : ""}><button onClick={() => {handleNav(4); setQty(6)}} onMouseOver={handlebeep}>A B O U T&nbsp;&nbsp;&nbsp;U S</button></li>
        <li className={subqty===5 ? "current" : ""}><button onClick={() => {handleNav(5); setQty(7)}} onMouseOver={handlebeep}>C O N T A C T</button></li>
        {/* <li className={subqty===6 ? "current" : ""}><button onClick={() => {handleNav(6); setQty(8)}} onMouseOver={handlebeep}></button></li>
        <li className={subqty===7 ? "current" : ""}><button onClick={() => {handleNav(7); setQty(9)}} onMouseOver={handlebeep}></button></li> */}
      </ul>
      ...
      <div className="layout">
        ...
        <section className="s2"><Products qty={qty}/></section>

        <section className="s3"><Buzz /></section>

        <section className="s4"><About /></section>

        <section className="s5"><Contact /></section>

        {/* <section className="s6"><Services /></section>

        <section className="s7"><Ovations /></section> */}
